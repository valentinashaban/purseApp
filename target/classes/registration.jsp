	...
	<div class="container">
		<div class="row">
			...
			<form class="col s12" id="reg-form" method="POST"
				...
				<div class="row">
					<div class="input-field col s12 m8 l6 offset-s0 offset-m2 offset-l3">
						<i class="material-icons prefix">account_circle</i>
						<label for="rlogin" class="">Login</label> <input id="rlogin"
				...
				<div class="row">
					<div class="input-field col s12 m8 l6 offset-s0 offset-m2 offset-l3">
						...
						<label for="rpassword">Password</label> <input id="rpassword"
				...
				<div class="row">
					<div class="input-field col s12 m8 l6 offset-s0 offset-m2 offset-l3">
						...
						<label for="cpassword">Confirm password</label> <input id="cpassword"
							type="password" name="cpassword" data-error=".errorTxt3">
